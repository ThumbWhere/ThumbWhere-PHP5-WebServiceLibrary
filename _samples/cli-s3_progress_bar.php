...
// DOWNLOAD SAMPLE FILE FROM S3
	...
	echo 'Downloading http://tw-sdk-for-php.s3.amazonaws.com/demo/big-buck-bunny.mp4' . PHP_EOL;
	echo 'Writing to ' . realpath('./downloads') . '/big-buck-bunny.mp4' . PHP_EOL;

	// Download a public object.
	$response = $s3->get_object('tw-sdk-for-php', 'demo/big-buck-bunny.mp4', array(
