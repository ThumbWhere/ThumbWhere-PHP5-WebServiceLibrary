...
/**
 * Default APICommerce Exception.
 */
class APICommerce_Exception extends Exception {
}
...
/**
 * TODO: Documentation from Commerce API index.xml
 *
 ...
 * @link http://thumbwhere.com/api/ ThumbWhere Commerce
 * @link http://thumbwhere.com/documentation/commerce/ ThumbWhere Commerce documentation
 */
class ThumbWhereAPICommerce extends TWRuntime {
  /*%******************************************************************************************%*/
  // CLASS CONSTANTS
  ...
  /**
   * Constructs a new instance of <ThumbWhereAPICommerce>. If the <code>TW_DEFAULT_CACHE_CONFIG</code> configuration
  ...
  /**
   * Sets the region to use for subsequent ThumbWhere APICommerce operations.
   *
   * @param string $region (Required) The region to use for subsequent ThumbWhere APICommerce operations. [Allowed values: `ThumbWhereAPICommerce::REGION_US_E1 `, `ThumbWhereAPICommerce::REGION_US_W1`, `ThumbWhereAPICommerce::REGION_EU_W1`, `ThumbWhereAPICommerce::REGION_APAC_SE1`, `ThumbWhereAPICommerce::REGION_APAC_NE1`]
