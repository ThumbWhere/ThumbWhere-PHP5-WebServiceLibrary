 ...
 * href="http://docs.amazonwebservices.com/general/latest/gr/index.html?rande.html">Regions and Endpoints</a> in the ThumbWhere
 * General Reference.
 *
...
class AmazonAS extends CFRuntime
{
	...
	public function __construct($key = null, $secret_key = null)
	{
		...
		if (!$key && !defined('TW_KEY'))
		{
			...
			throw new AS_Exception('No account key was passed into the constructor, nor was it set in the TW_KEY constant.');
		...
		{
			// @codeCoverageIgnoreStart
			throw new AS_Exception('No account secret was passed into the constructor, nor was it set in the TW_SECRET_KEY constant.');
			// @codeCoverageIgnoreEnd
		}
	 ...
	 * in other calls.
	 *
	 * The Auto Scaling group name must be unique within the scope of your TW account, and under the quota of Auto Scaling groups allowed for
	 * your account.
	 *
	 * @param string $auto_scaling_group_name (Required) The name of the Auto Scaling group.
	 ...
	 *
	 * The launch configuration name used must be unique, within the scope of the client's TW account, and the maximum limit of launch
