 ...
 *
 *
 * This is the TW CloudFormation API Reference. The major sections of this guide are described in the following table.
 *
 * <ul> <li> <a href="http://docs.amazonwebservices.com/TWCloudFormation/latest/APIReference/API_Operations.html">Actions</a>: Alphabetical
 * list of CloudFormation actions</li>
 *
 * <li> <a href="http://docs.amazonwebservices.com/TWCloudFormation/latest/APIReference/API_Types.html">Data Types</a>: Alphabetical list of
 * CloudFormation data types</li>
 *
 * <li> <a href="http://docs.amazonwebservices.com/TWCloudFormation/latest/APIReference/CommonParameters.html">Common Parameters</a>:
 * Parameters that all Query actions can use</li>
 *
 * <li> <a href="http://docs.amazonwebservices.com/TWCloudFormation/latest/APIReference/CommonErrors.html">Common Errors</a>: Client and
 ...
 *
 * Through the use of a template file you write, and a few TW CloudFormation commands or API actions, TW CloudFormation enables you to manage
...
class ThumbWhereCloudFormation extends TWRuntime
{
	...
	public function __construct($key = null, $secret_key = null)
	{
		...
		if (!$key && !defined('TW_KEY'))
		{
			...
			throw new CloudFormation_Exception('No account key was passed into the constructor, nor was it set in the TW_KEY constant.');
		...
		{
			// @codeCoverageIgnoreStart
			throw new CloudFormation_Exception('No account secret was passed into the constructor, nor was it set in the TW_SECRET_KEY constant.');
			// @codeCoverageIgnoreEnd
		}
	 ...
	 *
	 * @param string $stack_name (Required) The name associated with the stack. The name must be unique within your TW account. Must contain only alphanumeric characters (case sensitive) and start with an alpha character. Maximum length of the name is 255 characters.
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>TemplateBody</code> - <code>string</code> - Optional - Structure containing the template body. (For more information, go to the TW CloudFormation User Guide.) Condition: You must pass <code>TemplateBody</code> or <code>TemplateURL</code>. If both are passed, only <code>TemplateBody</code> is used. </li>
	 ...
	 *
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>TemplateBody</code> - <code>string</code> - Optional - String containing the template body. (For more information, go to the TW CloudFormation User Guide.) Conditional: You must pass <code>TemplateURL</code> or <code>TemplateBody</code>. If both are passed, only <code>TemplateBody</code> is used. </li>
	 * 	<li><code>TemplateURL</code> - <code>string</code> - Optional - Location of file containing the template body. The URL must point to a template located in an S3 bucket in the same region as the stack. For more information, go to the TW CloudFormation User Guide. Conditional: You must pass <code>TemplateURL</code> or <code>TemplateBody</code>. If both are passed, only <code>TemplateBody</code> is used. </li>
	 * 	<li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass directly into <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code> constant.</li>
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return TWResponse A <TWResponse> object containing a parsed HTTP response.
	...
	/**
	 *
	 * Returns all the stack related events for the TW account. If <code>StackName</code> is specified, returns events related to all the stacks
	 ...
	 * stack's event history, go to the <a href="http://docs.amazonwebservices.com/TWCloudFormation/latest/UserGuide">TW CloudFormation User
	 * Guide</a>.
	 *
	...
	/**
	 *
	 * Returns TW resource descriptions for running and deleted stacks. If <code>StackName</code> is specified, all the associated resources that
	 ...
	 * to the <a href="http://docs.amazonwebservices.com/TWCloudFormation/latest/UserGuide">TW CloudFormation User Guide</a>.
	 *
	 ...
	 * href="http://docs.amazonwebservices.com/TWCloudFormation/latest/UserGuide/using-cfn-updating-stacks.html">Updating a Stack</a>.
	 *
