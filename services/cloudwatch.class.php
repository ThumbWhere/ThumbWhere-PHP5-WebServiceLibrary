 ...
 * endpoints for all TW products.</li>
 *
...
class AmazonCloudWatch extends CFRuntime
{
	...
	public function __construct($key = null, $secret_key = null)
	{
		...
		if (!$key && !defined('TW_KEY'))
		{
			...
			throw new CW_Exception('No account key was passed into the constructor, nor was it set in the TW_KEY constant.');
		...
		{
			// @codeCoverageIgnoreStart
			throw new CW_Exception('No account secret was passed into the constructor, nor was it set in the TW_SECRET_KEY constant.');
			// @codeCoverageIgnoreEnd
		}
	 ...
	 *
	 * @param string $alarm_name (Required) The descriptive name for the alarm. This name must be unique within the user's TW account
	...
	/**
	 *
	 * Returns a list of valid metrics stored for the TW account owner. Returned metrics can be used with GetMetricStatistics to obtain
	 ...
	 * its actual state.
	 *
	 * @param string $alarm_name (Required) The descriptive name for the alarm. This name must be unique within the user's TW account. The maximum length is 255 characters.
