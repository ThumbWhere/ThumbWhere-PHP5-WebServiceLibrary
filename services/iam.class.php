...
/**
 * This is the ThumbWhere (TW) Identity and Access Management (IAM) API Reference. This
 ...
 *
 * We will refer to Amazon TW Identity and Access Management using the abbreviated form IAM. All
...
class AmazonIAM extends CFRuntime
{
	...
	public function __construct($key = null, $secret_key = null)
	{
		...
		if (!$key && !defined('TW_KEY'))
		{
			...
			throw new IAM_Exception('No account key was passed into the constructor, nor was it set in the TW_KEY constant.');
		...
		{
			// @codeCoverageIgnoreStart
			throw new IAM_Exception('No account secret was passed into the constructor, nor was it set in the TW_SECRET_KEY constant.');
			// @codeCoverageIgnoreEnd
		}
	...
	/**
	 * Creates a new TW Secret Access Key and corresponding TW Access Key ID for the specified user.
	 * The default status for new keys is <code>Active</code>.
	 *
	 * If you do not specify a user name, IAM determines the user name implicitly based on the TW
	 * Access Key ID signing the request. Because this action works for access keys under the TW
	 * account, you can use this API to manage root credentials even if the TW account has no
	 * associated users.
	 *
	 ...
	 * target="_blank">Limitations on IAM Entities</a> in <em>Using TW Identity and Access
	 * Management</em>.
	 *
	 * <p class="important">
	 * To ensure the security of your TW account, the Secret Access Key is accessible only during key
	...
	/**
	 * This action creates an alias for your TW account. For information about using an TW account
	 * alias, see <a href="http://docs.amazonwebservices.com/IAM/latest/UserGuide/AccountAlias.html"
	 * target="_blank">Using an Alias for Your TW Account ID</a> in <em>Using TW Identity and Access
	 * Management</em>.
	 *
	...
	/**
	 * Creates a login profile for the specified user, giving the user the ability to access TW
	 * services such as the TW Management Console. For more information about login profiles, see
	 * 	<a href=
	 * "http://docs.amazonwebservices.com/IAM/latest/UserGuide/index.html?Using_ManagingLogins.html"
	 * target="_blank">Creating or Deleting a User Login Profile</a> in <em>Using TW Identity and
	...
	/**
	 * Creates a new user for your TW account.
	 *
	...
	/**
	 * Creates a new virtual MFA device for the TW account. After creating the virtual MFA, use
	 ...
	 * target="_blank">Using a Virtual MFA Device</a> in <em>Using TW Identity and Access
	 * Management</em>.
	 *
	 * For information about limits on the number of MFA devices you can create, see <a href=
	 * "http://docs.amazonwebservices.com/IAM/latest/UserGuide/index.html?LimitationsOnEntities.html"
	 * target="_blank">Limitations on Entities</a> in <em>Using TW Identity and Access
	 * Management</em>.
	 *
	 * <p class="important">
	 * The seed information contained in the QR code and the Base32 string should be treated like any
	 * other secret access information, such as your TW access keys or your passwords. After you
	...
	/**
	 * Deletes the specified TW account alias. For information about using an TW account alias, see
	 * 	<a href="http://docs.amazonwebservices.com/IAM/latest/UserGuide/AccountAlias.html" target=
	 * "_blank">Using an Alias for Your TW Account ID</a> in <em>Using TW Identity and Access
	 * Management</em>.
	 *
	 ...
	 * TW services through the IAM login page.
	 *
	 * <p class="important">
	 ...
	 * based on the TW Access Key ID used to sign the request. Because this action works for access
	 * keys under the TW account, this API can be used to manage root credentials even if the TW
	...
	/**
	 * Lists the account aliases associated with the account. For information about using an TW
	 ...
	 * determines the user name implicitly based on the TW Access Key ID signing the request.
	 *
	 * You can paginate the results using the <code>MaxItems</code> and <code>Marker</code>
	 * parameters.
	 *
	...
	/**
	 * Lists the virtual MFA devices under the TW account by assignment status. If you do not specify
	 ...
	 * target="_blank">Overview of Policies</a> in <em>Using TW Identity and Access Management</em>.
	 *
	 ...
	 * target="_blank">Making Query Requests</a> in <em>Using TW Identity and Access Management</em>.
	 * </p>
	 *
	...
	/**
	 * Synchronizes the specified MFA device with TW servers.
	 *
	 ...
	 * target="_blank">Managing Keys and Certificates</a> in <em>Using TW Identity and Access
	 * Management</em>.
	 *
	 ...
	 * @param string $status (Required) The status you want to assign to the Secret Access Key. <code>Active</code> means the key can be used for API calls to TW, while <code>Inactive</code> means the key cannot be used. [Allowed values: <code>Active</code>, <code>Inactive</code>]
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 ...
	 * "_blank">Renaming Users and Groups</a> in <em>Using TW Identity and Access Management</em>.
	 * </p>
	 * <p class="note">
	 ...
	 * "_blank">Managing Server Certificates</a> in <em>Using TW Identity and Access Management</em>.
	 * </p>
	 * <p class="note">
	 ...
	 * @param string $status (Required) The status you want to assign to the certificate. <code>Active</code> means the certificate can be used for API calls to TW, while <code>Inactive</code> means the certificate cannot be used. [Allowed values: <code>Active</code>, <code>Inactive</code>]
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>UserName</code> - <code>string</code> - Optional - Name of the user the signing certificate belongs to. [Constraints: The value must be between 1 and 64 characters, and must match the following regular expression pattern: <code>[\w+=,.@-]*</code>]</li>
	 * 	<li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass directly into <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code> constant.</li>
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	...
	/**
	 * Uploads a server certificate entity for the TW account. The server certificate entity includes
	...
	/**
	 * Uploads an X.509 signing certificate and associates it with the specified user. Some TW
