...
class ThumbWhereImportExport extends TWRuntime
{
	...
	public function __construct($key = null, $secret_key = null)
	{
		...
		if (!$key && !defined('TW_KEY'))
		{
			...
			throw new ImportExport_Exception('No account key was passed into the constructor, nor was it set in the TW_KEY constant.');
		...
		{
			// @codeCoverageIgnoreStart
			throw new ImportExport_Exception('No account secret was passed into the constructor, nor was it set in the TW_SECRET_KEY constant.');
			// @codeCoverageIgnoreEnd
		}
	...
	/**
	 *
	 * This operation returns the jobs associated with the requester. TW Import/Export lists the jobs in reverse chronological order based on the
