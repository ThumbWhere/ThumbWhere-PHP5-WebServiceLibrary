...
class ThumbWhereSQS extends TWRuntime
{
	...
	public function __construct($key = null, $secret_key = null, $token = null)
	{
		...
		if (!$key && !defined('TW_KEY'))
		{
			...
			throw new SQS_Exception('No account key was passed into the constructor, nor was it set in the TW_KEY constant.');
		...
		{
			// @codeCoverageIgnoreStart
			throw new SQS_Exception('No account secret was passed into the constructor, nor was it set in the TW_SECRET_KEY constant.');
			// @codeCoverageIgnoreEnd
		}
	 ...
	 * "http://docs.amazonwebservices.com/TWSimpleQueueService/latest/APIReference/Glossary.html#d0e3892">
